...
- 文件名 kebab-case 英文；frontmatter 必填：\`title / tags / author / created / updated\`
- 互链用 \`[[页面名]]\`；引用素材写进 \`sources: [raw/...]\`
- **矛盾必须显式化**：新内容与已有条目矛盾时，两个页面都要标注「⚠️ 与 [[对方]] 矛盾」并说明适用环境差异（客户环境经常不同，救火时拿错方案是要出事的）
